...
export const CORE_ENDINGS: EndingConfig[] = [
  ...
  { id: 'burnout', title: '提前出局：长期燃尽未恢复', category: 'fail', condition: s => s.stats.burnout >= 95 || s.stats.mental <= 8 || crisisFailed(s, 'burnout'), text: '这不是意志力不足，而是长期过载没有得到恢复窗口。系统性压力最终压过了个人硬扛。' },
